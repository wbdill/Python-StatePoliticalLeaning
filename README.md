...
Subfolders within `data` folder (ex: `POTUS`) contain raw data files from authoritative sources.

# Data Sources

## POTUS 
- MIT Election Data + Science Lab (1976-2020): [Link](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/42MVDX)
- 2024 data from fec.gov: [Excel file](https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.fec.gov%2Fresources%2Fcms-content%2Fdocuments%2F2024presgeresults.xlsx&wdOrigin=BROWSELINK)
- Compiled Electoral College vote: [Google Sheet](https://docs.google.com/spreadsheets/d/1RPrW58dFiQprCtTSYP76wjHGlq0p_az3uJypPI0-PoY/edit?gid=72195602#gid=72195602)
